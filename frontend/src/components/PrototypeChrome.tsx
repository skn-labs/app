...
export function PrototypeStatusBar() {
  return <div aria-hidden="true" className="flex shrink-0 items-center justify-between px-7 pb-1 pt-3 text-[13px] font-semibold">
    <span>12:06</span>
...
export function PrototypeTopMark() {
  return <div className="flex shrink-0 justify-center pb-1 pt-2"><SknMark className="h-[26px] w-auto"/></div>
}

export function PrototypeHomeIndicator() {
  return <div aria-hidden="true" className="flex shrink-0 justify-center pb-2 pt-1"><i className="block h-[5px] w-[134px] rounded-full bg-[#0a0a0a]"/></div>
}
