...
<div class="pad">
  ...
  <div style="position:absolute;right:76px;bottom:44px;font-size:15px;color:var(--accent);font-weight:600">skn.today</div>
</div>""")
...
<div class="pad">
  ...
  <div style="position:absolute;left:790px;top:250px;right:76px;text-align:center">
    ...
    <div style="font-size:18px;font-weight:600;margin-top:22px">skn.today</div>
...
<div class="pad">
  ...
  <hr class="hr" style="position:absolute;left:76px;right:76px;bottom:78px">
  <div style="position:absolute;left:76px;bottom:44px;font-size:15px;color:var(--sageon);font-weight:600">skn.today</div>
