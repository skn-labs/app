...
public class AuthService {
    ...
    public AuthService(AuthRepository repository, AccessTokenService accessTokens, TestHarnessProperties testHarness) {
    ...
    @Transactional
    public AuthView signUp(SignUpRequest request, HttpServletRequest servletRequest, HttpServletResponse servletResponse) {
        ...
        accessTokens.issue(servletRequest, servletResponse, userId);
        return repository.findUser(userId).orElseThrow();
    }

    @Transactional
    public AuthView quickSignUp(HttpServletRequest servletRequest, HttpServletResponse servletResponse) {
    ...
    public AuthView login(LoginRequest request, HttpServletRequest servletRequest, HttpServletResponse servletResponse) {
        String username = normalizeUsername(request.username());
    ...
    public AuthView demo(HttpServletRequest servletRequest, HttpServletResponse servletResponse) {
        accessTokens.issue(servletRequest, servletResponse, 1L);
    ...
    public AuthView quickLogin(String rawUsername, HttpServletRequest servletRequest, HttpServletResponse servletResponse) {
        requireTestHarness();
    ...
    public void logout(HttpServletRequest request, HttpServletResponse response) {
        accessTokens.revoke(request, response);
    }

    @Transactional
    public void deleteAccount(CurrentUser currentUser, HttpServletRequest request, HttpServletResponse response) {
